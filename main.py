...
layout = [[sg.Text('クイ～ズ クイズ！', font=25, justification='center')],
          ...
          [sg.Button('九九2～5', size=(16, 2), pad=((10, 5), 10)), sg.Button('九九6～9', size=(16, 2), pad=((5, 10), 10))],
          [sg.Frame(layout=[
...
main_window = sg.Window('Keypad', layout, default_button_element_size=(10, 2), size=(350, 500),
